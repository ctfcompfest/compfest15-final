...
export default function Home({
  ...
  const sendContent = async () => {
    ...
    .then((res) => res.json())
    .then((data) => {
      if (data.status === "success") return router.push(`/code/${codeId}`);
  ...
  return (
    ...
    >
      <title>New | Writeup Editor</title>
      ...
      <Toaster />
      <h1 className="my-5 text-xl"><strong>Create new markdown content</strong></h1>
